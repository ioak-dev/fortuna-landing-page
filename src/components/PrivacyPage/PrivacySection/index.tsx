  ...
  return (
    <div className="privacy-section">
      <div className="privacy-section--container column-layout">
        <h1>Privacy Policy for Expenso</h1>

        <p>
          At Expenso, accessible from https://expenso.ioak.org, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Expenso and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Expenso. This policy is not applicable to any
        ...
        <p>
          Expenso follows a standard procedure of using log files. These files log
        ...
        <p>
          Like any other website, Expenso uses 'cookies'. These cookies are used
        ...
        <p>
          ...
          advertising partners of Expenso.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Expenso, which are sent directly
        ...
        <p>
          Note that Expenso has no access to or control over these cookies that
        ...
        <p>
          Expenso's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          Expenso does not knowingly collect any Personal Identifiable Information
